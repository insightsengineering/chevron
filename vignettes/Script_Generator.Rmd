...
By default, the generated script is printed in the console but it can also be saved in a file whose address in passed to the `con` argument. 
...
tmp <- tempfile("my_script", fileext = "R")
script(dmt01_1, con = tmp, dict = dict, details = TRUE)
```
