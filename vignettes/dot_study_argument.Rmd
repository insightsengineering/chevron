...
## `evo_vars_labs`
The label associated with the variables selectes in `evo_vars`.
...
## `visitvar`
The variable used to define the visits. (Could this variable be different for ecah table, in which case it should be out of the `.study` object.)
