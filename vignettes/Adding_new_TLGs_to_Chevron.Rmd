...
The following variables are best hard coded in the table-genrating functions (with the possibility to the user to
...
- "Patient" or "Subject" (the designation of the person depends on the study)
