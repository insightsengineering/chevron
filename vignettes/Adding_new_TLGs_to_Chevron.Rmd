...
- `gradation` (used in aet03): ...... options: `c("MILD", "MODERATE", "SEVERE", "LIFE THREATENING")`, .... 
- `lbl_overall` (used everywhere) options:
- `reason` (used in dst01): options: .... 
- `status` (used in dst01): options: .... 
- `summaryvars` (used in dmt01): .... 

Generally defined at the study level
- "Patient" or "Subject"
- Randomized arm variable
