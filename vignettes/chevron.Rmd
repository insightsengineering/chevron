...
1. have the `...` argument to facilitate their incorporation in a pipline.
...
# or
aet02_1@preprocess(adam_study_data)
```
...
run(my_pipline, adam_study_data)
```
