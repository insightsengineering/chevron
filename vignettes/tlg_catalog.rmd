...
run(aet01, syn_data, anl_vars = list(safety_var = c("FATAL", "SER", "RELSER", "RELCTC35")))
```
...
run(dmt01, syn_data, summaryvars = c("AGE", "AGEGR1", "SEX", "ETHNIC", "RACE", "BBMIGR1"))
```
...
run(dmt01, syn_data, summaryvars = c("AGE", "AGEGR1", "SEX", "ETHNIC", "RACE", "DIABPBL"))
```
