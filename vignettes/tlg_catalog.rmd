...
syn_data$adsl <- syn_data$adsl %>%
  ...
  mutate(BBMIGR1 = factor(BBMIGR1, levels = c(
...
The syntax below adds the end of treatment status to the standard patient disposition summary by providing the end of treatment status variable to the parameter *trt_status_var*.  t
