...
Additional analyses can be added with the parameter `aesi_vars`, please type `?aet01_aesi` in Rstudio console to find out the list of all pre-defined optional analyses in the HELP.
