...
#### **3. Multi-variable Cox Regression (Setting Strata, Ties, Alpha Level, and Statistics)**
...
```{r}
run(kmg01, proc_data, dataset = "adaette", annot_coxph = FALSE)
```
...
#### **2. Plot of Mean (+/-SD) (Changing the Statistics)**
...
#### **3. Plot of Mean and Confidence Interval (Customize Table Output)**
...
#### **4. Plot of Mean and Confidence Interval (Customize Plot Appearance)**
