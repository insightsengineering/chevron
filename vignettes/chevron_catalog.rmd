...
1) A stratified analysis can be added by specifying the argument `perform_analysis = "strat"` and provide the stratification variable to the argument `strata = c ("STRATA1","STRATA2"). The argument `strata` is expected if `perform_analysis` is set to include stratified analysis.  
