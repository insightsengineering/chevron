...
std_preprocessing_map <- tibble::tribble(
  ...
  "cmt01a_1", "filter_adcm_anl01fl", NA, c("adsl", "adcm"),
  "cmt01a_2", "filter_adcm_anl01fl", NA, c("adsl", "adcm"),
  "cmt01a_3", "filter_adcm_anl01fl", NA, c("adsl", "adcm"),
  "cmt02_pt_1", "filter_adcm_anl01fl", NA, c("adsl", "adcm"),
