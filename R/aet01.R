...
aet01_main <- function(adam_db,
                       ...
                       anl_lbls = "Total number of {patients_label} with at least one",
                       ...) {
...
aet01_lyt <- function(arm_var,
  ...
  lyt_ae1 <- lyt_base %>%
    analyze_num_patients(
      ...
      .labels = c(
        unique = render_safe("Total number of {patients_label} with at least one AE"),
  ...
  lyt_adsl <- lyt_base %>%
    ...
    count_patients_with_event(
      ...
      denom = "N_col",
      .labels = c(count_fraction = render_safe("Total number of {patients_label} withdrawn from study due to an AE")),
