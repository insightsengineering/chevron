...
#'  * `adam_db` object must contain an `adae` table with the columns passed to `safety_var`. These columns may be one of
#'  column generated by the corresponding `preprocess` function.
#'
#' @export
#'
