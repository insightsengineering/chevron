# ael02 works with adae dataset
    ...
    Output
      ...
      \s\n                                                                                                 
                                                                            Study       AE             
                                                                            Day of   Duration          
      Center/Patient ID            Age/Sex/Race              Treatment      Onset    in Days    Serious
      —————————————————————————————————————————————————————————————————————————————————————————————————
      ...
      Center/Patient ID            Age/Sex/Race              Treatment      Intensity     Drug        (1)  
      —————————————————————————————————————————————————————————————————————————————————————————————————————
...
# ael02 can handle all missing values
    ...
    Output
      ...
      BRA-11/id-321       33/F/ASIAN                       <Missing>   <Missing>        06OCT2020     
                                                                       ...
                                                                       <Missing>        06OCT2020     
                                                                       <Missing>        06OCT2020     
      BRA-11/id-345       37/F/WHITE                       <Missing>   <Missing>        18AUG2020     
                                                                       <Missing>        18AUG2020     
                                                                       <Missing>        18AUG2020     
                                                                       <Missing>        18AUG2020     
      ...
      BRA-1/id-141        35/F/WHITE                       <Missing>    388        11      No     
                                                                        ...
                                                                        952        66      No     
                                                                        1094       3       Yes    
      BRA-1/id-236        32/M/BLACK OR AFRICAN AMERICAN   <Missing>     33       615      Yes    
                                                                        271       776      Yes    
                                                                        1052       7       Yes    
