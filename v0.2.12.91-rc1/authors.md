...
Source:
[`DESCRIPTION`](https://github.com/insightsengineering/chevron/blob/v0.2.12.91-rc1/DESCRIPTION)

Li L, Falquet B, Duan X (2026). *chevron: Standard TLGs for Clinical
Trials Reporting*. R package version 0.2.12.91,
<https://insightsengineering.github.io/chevron/>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 0.2.12.91},
